package kreandoapp.mpsupervisores.modoadmin.Productos;
...
public class editarimagenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference myRef3 = database2.getReference("Productos").child(key).child("prodImagen");
        ...
        seleccione_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.startPickImageActivity(editarimagenActivity.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(editarimagenActivity.this).load(thumb_filePathUri).into(img_foto);
                        ...
                        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    final DatabaseReference myRef4 = database3.getReference("Productos").child(key).child("prodImagen");
                                    myRef4.setValue(downloadUri.toString());

                                    FirebaseDatabase database5 = FirebaseDatabase.getInstance();
                                    final DatabaseReference myRef5 = database5.getReference("Productos").child(key).child("prodUrlenproceso");
                                    ...
                                    storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(editarimagenActivity.this, "se borro bien", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {

                                        @Override
                                        public void onFailure(@NonNull Exception exception) {
                                            Toast.makeText(editarimagenActivity.this, "ups. un error al subir.", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    finish();
