...
public class EliminarSubcategoriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_subcategoria);
        ...
        btnsi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query query2 = myRef3.child("Productos").orderByChild("prodCategoriaID").equalTo(id);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists()){
                            ...
                            for (DataSnapshot childSnapshot: dataSnapshot.getChildren()) {
                                ...
                                FirebaseDatabase database2 = FirebaseDatabase.getInstance();
                                DatabaseReference myRef3 = database2.getReference("Productos").child(key).child("prodUrlenproceso");
                                ...
                                DatabaseReference myRef4 = database22.getReference("Productos").child(key);
                                myRef4.removeValue();

                                FirebaseDatabase database255 = FirebaseDatabase.getInstance();
                                DatabaseReference myRef555 = database255.getReference("SubCategoria").child(id).child("subUrlCambiar");
                                        ...
                                        if(dataSnapshot.exists()){
                                            ...
                                            storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    ...
                                                    DatabaseReference myRef5 = database23.getReference("SubCategoria").child(id);
                                                    myRef5.removeValue();



                                                    Toast.makeText(EliminarSubcategoriaActivity.this, "sub Categoria Eliminada", Toast.LENGTH_SHORT).show();
                                                }
                                            }).addOnFailureListener(new OnFailureListener() {
                            ...
                            storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(EliminarSubcategoriaActivity.this, "Categoria Eliminada", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
