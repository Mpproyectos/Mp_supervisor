...
public class eliminarcategoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminarcategoria);
                ...
                query2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot childSnapshot: dataSnapshot.getChildren()) {
                            ...
                            DatabaseReference myRef555 = database255.getReference("Categoria").child(id).child("catUrlCambiarImagen");
                                    ...
                                    if(dataSnapshot.exists()){
                                        ...
                                        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                DatabaseReference myRef5 = database23.getReference("Categoria").child(id);
                                                myRef5.removeValue();



                                                Toast.makeText(eliminarcategoria.this, "Categoria Eliminada", Toast.LENGTH_SHORT).show();
                                            }
                                        }).addOnFailureListener(new OnFailureListener() {
