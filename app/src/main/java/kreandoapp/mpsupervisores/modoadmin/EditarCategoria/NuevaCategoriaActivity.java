...
public class NuevaCategoriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Nueva Categoria");
        ...
        btn_elige_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.startPickImageActivity(NuevaCategoriaActivity.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(NuevaCategoriaActivity.this).load(thumb_filePathUri).into(img_categoria);
                ...
                btn_subir_categoria.setOnClickListener(v -> {
                    ...
                    if(TextUtils.isEmpty(name_categoria)){
                        Toast.makeText(NuevaCategoriaActivity.this, "Completa todos los campos", Toast.LENGTH_SHORT).show();
                        ...
                        Task<Uri> urlTask = uploadTask.continueWithTask(task -> {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                /*Coctelpojo coc = new Coctelpojo(
                                        push,name_categoria,downloadUri.toString(),"imagenes_comprimidas/"+aleatorio2,2
                                );*/
                                Categoria cat = new Categoria(
                                     name_categoria,
                                     downloadUri.toString(), "imagenes_comprimidas/"+aleatorio2,
                                     push,
                                     2
                                ...
                                categoriaref.child(push).setValue(cat);
                                Toast.makeText(NuevaCategoriaActivity.this, "Nueva Categoria Cargado.", Toast.LENGTH_SHORT).show();
