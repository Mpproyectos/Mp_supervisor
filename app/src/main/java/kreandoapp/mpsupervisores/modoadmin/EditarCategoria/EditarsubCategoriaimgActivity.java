package kreandoapp.mpsupervisores.modoadmin.EditarCategoria;
...
public class EditarsubCategoriaimgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editarsub_categoriaimg);


        toolbar = findViewById(R.id.tb_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Editar Imagen de subcategoria");
        ...
        DatabaseReference myRef3 = database2.getReference("SubCategoria").child(key).child("subImagen");
        ...
        seleccione_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.startPickImageActivity(EditarsubCategoriaimgActivity.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(EditarsubCategoriaimgActivity.this).load(thumb_filePathUri).into(img_foto);
                    ...
                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                final DatabaseReference myRef4 = database3.getReference("SubCategoria").child(key).child("subImagen");
                                myRef4.setValue(downloadUri.toString());

                                FirebaseDatabase database5 = FirebaseDatabase.getInstance();
                                final DatabaseReference myRef5 = database5.getReference("SubCategoria").child(key).child("subUrlCambiar");
                                ...
                                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(EditarsubCategoriaimgActivity.this, "se borro bien", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {

                                    @Override
                                    public void onFailure(@NonNull Exception exception) {
                                        Toast.makeText(EditarsubCategoriaimgActivity.this, "ups. un error al subir.", Toast.LENGTH_SHORT).show();
                                    }
                                });
