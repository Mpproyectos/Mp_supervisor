    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_actualizardatos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final DatabaseReference myRef6 = database.getReference("Categoria").child(key).child("catNombre");
                myRef6.setValue(et_nombre.getText().toString());


                final DatabaseReference myRef7 = database.getReference("Categoria").child(key).child("orden");

                myRef7.setValue(Integer.parseInt(et_orden.getText().toString()));


                finish();
                Toast.makeText(editarCategoriaActivity.this, "Categoria editada!", Toast.LENGTH_SHORT).show();
        ...
        btn_actualizarfotos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final String key = getIntent().getExtras().getString("id");
                Intent i = new Intent(getApplicationContext(), EditarCategoriaImgActivity.class);
                i.putExtra("key",key);
