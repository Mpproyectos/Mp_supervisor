package kreandoapp.mpsupervisores.modoadmin.Promo;
...
public class eliminarpromo extends AppCompatActivity {
    Button btnsi,btnno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminarpromo);
        ...
        btnsi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final DatabaseReference myRef4 = database3.getReference("Promo").child(key);
                myRef4.removeValue();

                Toast.makeText(eliminarpromo.this, "Promocion eliminada!", Toast.LENGTH_SHORT).show();
