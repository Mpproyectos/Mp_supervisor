...
public class EditarimgCoctelcateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editarimg_coctelcate);

        toolbar = findViewById(R.id.tb_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Editar Imagen de Coctel cate");
        ...
        DatabaseReference myRef3 = database2.getReference("Coctel").child(key).child("miniatura");
        ...
        seleccione_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.startPickImageActivity(EditarimgCoctelcateActivity.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(EditarimgCoctelcateActivity.this).load(thumb_filePathUri).into(img_foto);
                    ...
                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                final DatabaseReference myRef4 = database3.getReference("Coctel").child(key).child("miniatura");
                                myRef4.setValue(downloadUri.toString());

                                FirebaseDatabase database5 = FirebaseDatabase.getInstance();
                                final DatabaseReference myRef5 = database5.getReference("Coctel").child(key).child("urlcambiar");
                                ...
                                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(EditarimgCoctelcateActivity.this, "se borro bien", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {

                                    @Override
                                    public void onFailure(@NonNull Exception exception) {
                                        Toast.makeText(EditarimgCoctelcateActivity.this, "ups. un error al subir.", Toast.LENGTH_SHORT).show();
                                    }
                                });
