package kreandoapp.mpsupervisores.modoadmin.Coctels;
...
public class EditarimgcoctelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editarimgcoctel);


        toolbar = findViewById(R.id.tb_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Editar Imagen de Coctel");
        ...
        DatabaseReference myRef3 = database2.getReference("imgcoctel").child(key).child("foto");
        ...
        seleccione_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.startPickImageActivity(EditarimgcoctelActivity.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(EditarimgcoctelActivity.this).load(thumb_filePathUri).into(img_foto);
                ...
                subirproducto.setOnClickListener(v -> {
                   ...
                   // UploadTask uploadTask2 = ref.putBytes(thumb_filePathUri);
                    ...
                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                final DatabaseReference myRef4 = database3.getReference("imgcoctel").child(key).child("foto");
                                myRef4.setValue(downloadUri.toString());

                                FirebaseDatabase database5 = FirebaseDatabase.getInstance();
                                final DatabaseReference myRef5 = database5.getReference("imgcoctel").child(key).child("urlfotocambiar");
                                myRef5.setValue("imagenes_comprimidas2/"+aleatorio2);
                                ...
                                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(EditarimgcoctelActivity.this, "se borro bien", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {

                                    @Override
                                    public void onFailure(@NonNull Exception exception) {
                                        Toast.makeText(EditarimgcoctelActivity.this, "ups. un error al subir.", Toast.LENGTH_SHORT).show();
                                    }
                                });
