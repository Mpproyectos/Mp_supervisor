...
import kreandoapp.mpsupervisores.clientes.ConfirmarNodoActivity;
...
public class ConfirmarUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_titulo_toolbar.setText("Confirmar finalizacion de nodo");
        ...
        tv_texto.setText("¿Seguro quieres autorizar a :" + nombre_usuario + " , con el numero de nodo: " + nombre_nodo +" finalizado");
        ...
        btn_autorizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ConfirmarUsuario.this, ConfirmarNodoActivity.class);
                startActivity(i);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    clase.volleyfcm_sinfoto("Hola  " + nombre_user, " Se autorizo como finalizado el nodo " + nombre_nodo, token, "modoadmin");
                    ...
                    myRef5.child("autorizacion2").setValue("ok");
