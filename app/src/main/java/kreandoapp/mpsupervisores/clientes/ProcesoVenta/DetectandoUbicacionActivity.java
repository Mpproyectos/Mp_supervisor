...
public class DetectandoUbicacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detectando_ubicacion);
    ...
    private void ubiygps() {
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(
                    DetectandoUbicacionActivity.this,
    ...
    private void getCurrentLocation() {
        ...
        LocationServices.getFusedLocationProviderClient(DetectandoUbicacionActivity.this).
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if(locationResult != null && locationResult.getLocations().size() >0){
                           ...
                           longitudeUser = locationResult.getLocations().get(latestLocationIndex).getLongitude();
                            ...
                            Query query2 = myRef3.child("precioenvio").child("estado");
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (dataSnapshot.exists()) {
                                        if (val.equals("activo")) {
                                          ...
                                          damemodoadmin(latitudUser,longitudeUser);
    ...
    private void vamosacarrito(int envio,String rango) {
        Intent i = new Intent(DetectandoUbicacionActivity.this, Carrito.class);
        i.putExtra("latitudUser",Double.toString(latitudUser));
        i.putExtra("longitudUser",Double.toString(longitudeUser));
        i.putExtra("valor_envio",envio);
        i.putExtra("valor_rango",rango);
