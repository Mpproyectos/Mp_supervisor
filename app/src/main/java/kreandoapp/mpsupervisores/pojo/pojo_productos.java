...
public class pojo_productos {
    ...
    public pojo_productos() {
    }

    public pojo_productos(String codProd, String prodNombre, String prodImagen, String prodDescripcion, String prodPrecio, String prodId, String prodCategoriaID, String prodCantidad, String prodUrlenproceso, String prodStock, int orden) {
